        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('YOUR SESSION WILL BE FOR ', style: k16BoldTS),
              Padding(
                padding: const EdgeInsets.only(top: 15.0, bottom: 5),
                child: SvgPicture.asset('assets/images/clock.svg',
                    color:
                        UIParameters.isDarkMode(context) ? Colors.white : null),
              ),
              Obx(
              ...
              Obx(() {
                ...
                return Padding(
                  ...
                  child: TextButton(
                      onPressed: () {
                        _trainerInPersonSessionController.showTimes.toggle();
                      },
                  ...
                  children: [
                    StaticsWidget(
                        ...
                        lable2: _trainerInPersonSessionController
                            ...
                            ? 'N/A'
                            : _trainerInPersonSessionController
                                .sessionDistandeDuratiom.value!.distance.text),
                    Obx(() => StaticsWidget(
